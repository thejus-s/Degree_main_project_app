...
public class cameraopen extends AppCompatActivity {
    ...
    private class GraphicFaceTracker extends Tracker<Face> {
        ...
        GraphicFaceTracker(GraphicOverlay overlay) {
            ...
            this.mFaceGraphic = new FaceGraphic(this.mOverlay, cameraopen.this.mAlertHandler,getApplicationContext());
        }
        ...
        public void onUpdate(Detector.Detections<Face> detections, Face face) {
            if (face!=null)
            {
                Intent i=new Intent(cameraopen.this,Camera.class);
                startActivity(i);
            }
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, "android.permission.CAMERA")) {
            Snackbar.make(this.mGraphicOverlay, R.string.permission_camera_rationale, 2).setAction(R.string.ok, new View.OnClickListener() {
                public void onClick(View view) {
                    ActivityCompat.requestPermissions(cameraopen.this, permissions, cameraopen.RC_HANDLE_CAMERA_PERM);
                }
            }).show();
            return;
        }
...
//        Sounds.initAlertSound(this);
        this.mAlertHandler = new Handler(new Handler.Callback() {
            public boolean handleMessage(Message msg) {
                switch (msg.what) {
                    case cameraopen.MSG_SHOW_DIALOG /*0*/:
                        if (!(cameraopen.this.mAlertDialog == null || cameraopen.this.mAlertDialog.isShowing())) {
//                            MainActivity2.this.mAlertDialog.show();
//                            Sounds.alert();
                            break;
                        }
                    case cameraopen.MSG_DISMISS_DIALOG /*1*/:
                        if (cameraopen.this.mAlertDialog != null && cameraopen.this.mAlertDialog.isShowing()) {
